(function () {
  ...
  const ENABLE_AD_BLOCK = 'enableAdBlock';
  const DISABLE_ANIMATIONS = 'disableAnimations';
  const SHOW_CLAIM_POINTS_MESSAGE = 'showClaimPointsMessage';
  const SHOW_CURRENT_POINTS = 'showCurrentPoints';
  const SHOW_BLOCKING_ADS_MESSAGE = 'showBlockingAdsMessage';
  const LOAD_EMOTES = 'loadEmotes';
  ...
  function configAddChangeListener(key, callback) {
  ...
  function showNotification(text, time = 7000, type = 'success') {
